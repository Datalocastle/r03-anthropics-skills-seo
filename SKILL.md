        ---
        name: "r00-anthropics-skills--seo"
        description: >
          📈 SEO & Content Marketing skill suite derived from anthropics/skills.
...
- `/content-calendar` — Data-driven editorial calendar built from search demand and seasonality
        ...
        ```bash
        # Install this skill
        cp -r . ~/.claude/skills/r00-anthropics-skills--seo/

        # In Claude Code
        /read ~/.claude/skills/r00-anthropics-skills--seo/SKILL.md
        ```
